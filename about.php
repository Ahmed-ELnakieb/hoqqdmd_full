...
<!-- Contact Section -->
<section class="contact-area pt-90 pb-90" style="background: #f8f9fa;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center mb-5">
                <div class="section-title">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="contact-item text-center">
                    ...
                    <h4>Telegram</h4>
                    <p><a href="https://t.me/hoqqdmdhack" target="_blank">@hoqqdmdhack</a></p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="contact-item text-center">
                    ...
                    <h4>WhatsApp</h4>
                    <p><a href="https://chat.whatsapp.com/JYHU6uidE4N3uwgUY1i6Fo" target="_blank">Join Group</a></p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="contact-item text-center">
                    ...
                    <h4>YouTube</h4>
                    <p><a href="https://www.youtube.com/@hoqqdmd" target="_blank">@hoqqdmd</a></p>
                </div>
            </div>
        </div>
    </div>
